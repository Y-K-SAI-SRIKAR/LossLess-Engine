...
void main() {
    ...
    vec3 finalColor = mix(ditherColor, color.rgb, revealAmount);
    float pixelBrightness = max(max(finalColor.r, finalColor.g), finalColor.b);
    float alpha = smoothstep(0.01, 0.05, pixelBrightness) * color.a; 
...
const __originkitPresetProps = {
  "image": {
    "src": "blob:https://www.originkit.dev/d65de897-b228-4eb7-80bc-a16033f6dcad"
  },
  "focusY": 21,
  "dotSize": 1,
  "revealRadius": 165,
